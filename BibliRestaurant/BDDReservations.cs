...
namespace BibliRestaurant
{
    internal class BDDReservations : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Reservation() { ID = 1, NomPrenom = "Fontaine Jesper", NombrePersonnes = 3, ZoneRestaurant = Zones.Térasse, DateReservation = new DateTime(2022, 8, 22,14,30,10), Email = "JesperFontaine@dayrep.com", NumeroTelephone = "+32484674671", NuméroTable = 25, Adresse = "Avenue Boziere 8 BP 7500 tournai", ChoixDuDécor = Décor.Africain, TypeDeMenu = TypePlat.Américain, PlaceParking = 2 },
            ...
            new Reservation() { ID = 9, NomPrenom = "Boncoeur Christabel",NombrePersonnes = 3,ZoneRestaurant = Zones.Térasse,DateReservation = new DateTime(2022, 9, 1, 13, 15, 3), Email = "ChristabelBoncoeur@fai.com", NumeroTelephone = "+32477986657", NuméroTable = 8, Adresse = "Rue Morel 34 BP 7500 tournai",ChoixDuDécor = Décor.Asiatique,TypeDeMenu = TypePlat.Européen, PlaceParking = 12 },
            ...
            new Reservation() { ID = 12, NomPrenom = "Rep  Aniel", NombrePersonnes = 3, ZoneRestaurant = Zones.Térasse, DateReservation = new DateTime(2022, 12, 5, 20, 30, 7), Email = "AnielRep@touristsagency.com", NumeroTelephone = "+32473432452", NuméroTable = 41,Adresse = "Grand Place 12 BP 7500 tournai", ChoixDuDécor = Décor.Variété, TypeDeMenu = TypePlat.Variété, PlaceParking = 17 },
